...
## Does app.abg.garden support a custom domain?
...
This is a method to disable your app.abg.garden account which won't allow any bookings once initiated. However, bookings made before turning on *away mode* will still be booked.
