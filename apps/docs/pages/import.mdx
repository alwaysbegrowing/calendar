...
5. Press **Copy token** and then paste it into the app.abg.garden importer
<Callout>
...
4. Click to copy the token, and then paste the token into the app.abg.garden importer
<Callout>
