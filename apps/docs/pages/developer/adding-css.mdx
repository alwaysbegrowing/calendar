...
<Callout>
  Adding or modifying CSS counts as changing the code, so as per [our license](https://github.com/alwaysbegrowing/calendar/blob/main/LICENSE) you must either open-source your modified version or purchase an enterprise license.
</Callout>

app.abg.garden uses [TailwindCSS](https://tailwindcss.com) as a replacement for traditional CSS styling within the application, but some people prefer to add CSS styles themselves.
