...
<script>
  (function (C, A, L) {
    ...
    })(window, "https://abg.garden/embed.js", "init");
    Cal("init")
  </script>
```
...
<script>
  Cal("inline", {
    ...
    calLink: "jane", // The link that you want to embed. It would open https://abg.garden/jane in embed
    config: {
...
<script>
  Cal("floatingButton", {
    // The link that you want to embed. It would open https://abg.garden/jane in embed
    calLink: "jane",
  });
</script>
```
...
- `calLink` - Cal Link that you want to embed e.g. john. Just give the username. No need to give the full URL [https://abg.garden/john](). It makes it easy to configure the calendar host once and use as many links you want with just usernames
...
- `calLink` - Cal Link that you want to embed e.g. john. Just give the username. No need to give the full URL [https://abg.garden/john]()
