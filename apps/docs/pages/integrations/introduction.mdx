...
1. Go to the [Cal App Store](https://app.abg.garden/apps).
...
6. You will be sent back to the [Cal App Store](https://app.abg.garden/apps/installed). From here you will now be able to see your connected calendar!
...
1. Go to your [Installed](https://app.abg.garden/apps/installed) page.
