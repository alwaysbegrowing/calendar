...
1. Go to the [Cal App Store](https://app.abg.garden/integrations).
...
3. You will be redirected to Stripe requesting for app.abg.garden to be authorized access. Press 'Accept'.
