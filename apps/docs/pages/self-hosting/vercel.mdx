...
1. Fork and clone the repository
   ...
   ```bash
   git clone https://github.com/<your-fork>/abg.garden.git
   ```

2. Copy the `.env.example` file in `apps/web`, rename it to `.env` and fill it with your settings ([See manual setup](https://github.com/alwaysbegrowing/calendar#manual-setup) and [Obtaining the Google API Credentials](https://github.com/alwaysbegrowing/calendar#obtaining-the-google-api-credentials))
