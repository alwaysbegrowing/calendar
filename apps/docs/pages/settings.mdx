...
1. Go to your [Profile Settings](https://app.abg.garden/settings/profile).
...
- Enabling or Disabling abg.garden Branding on your Booking Page
3. Once you have completed all your changes, press that 'save' button located at the bottom right of your page.

## Reset your password

1. Go to [your account security settings](https://app.abg.garden/settings/security).
...
Go to [Profile Settings](https://app.abg.garden/settings/profile). There, you will see the email associated with your account which you can then update. You’d just need to log out and back in to see the change take effect.
...
Go to your [Profile Settings](https://app.abg.garden/settings/profile). Under `Language` you will see the dropdown menu and you can use it to select your desired language.
