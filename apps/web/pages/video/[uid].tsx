...
export default function JoinCall(props: JoinCallPageProps) {
  ...
  return (
    <>
      <Head>
        <title>app.abg.garden Video</title>
        <meta name="title" content="app.abg.garden Video" />
        ...
        <meta property="og:title" content="app.abg.garden Video" />
        ...
        <meta property="twitter:title" content="app.abg.garden Video" />
