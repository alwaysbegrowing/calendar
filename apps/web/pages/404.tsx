...
export default function Custom404() {
  ...
  const isCalcom = process.env.NEXT_PUBLIC_WEBAPP_URL === "https://app.abg.garden";
    ...
    <>
      ...
      <div className="min-h-screen bg-white px-4" data-testid="404-page">
        <main className="mx-auto max-w-xl pt-16 pb-6 sm:pt-24">
          {isSignup && process.env.NEXT_PUBLIC_WEBAPP_URL !== "https://app.abg.garden" ? (
            <div>
              <div>
                ...
                {isSubpage ? (
                  ...
                  <Link href={url}>
                    <a className="mt-2 inline-block text-lg">
                      {t("the_username")} <strong className="text-blue-500">abg.garden{username}</strong>{" "}
