...
If you run it on localhost, check out the [additional information](https://github.com/CarinaWolli/abg.garden/edit/feat/zapier-app/packages/app-store/zapier/README.md#localhost) below.
...
4. Create Integration
   - Name: app.abg.garden
   - Description: app.abg.garden is a scheduling infrastructure for absolutely everyone.
...
4. Test your authentication —> First you have to install Zapier in the app.abg.garden App Store and generate an API key, use this API key to test your authentication (only zapier Api key works)
